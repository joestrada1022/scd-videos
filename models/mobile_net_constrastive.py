...
class MobileNetContrastive(BaseNet):
    ...
    def __create_encoder(input_shape, pretrained=False):
        ...
        encoder = tf.keras.applications.MobileNetV3Small(input_shape=input_shape, include_top=False,
                                                         weights=weights, include_preprocessing=False)
        return encoder
...
if __name__ == '__main__':
    net = MobileNetContrastive(num_batches=10, global_results_dir=Path('.'), const_type=None, model_path=None)
