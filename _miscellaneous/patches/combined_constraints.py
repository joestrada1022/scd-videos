...
def get_patch_locations(img_data, max_std_dev, min_std_dev, patch_dimensions, patches_type):
    """
...
if __name__ == '__main__':
    image_path = Path(r'/scratch/p288722/datasets/vision/all_frames/D03_Huawei_P9/D03_V_flat_move_0001/D03_V_flat_move_0001-00001.png')

    img = cv2.imread(str(image_path))
    img = np.float32(img) / 255.0

    h_map = get_patch_locations(
        img,
