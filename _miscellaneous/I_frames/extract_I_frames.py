...
def extract_I_frames(dataset_root_dir):
    all_video_paths = list(dataset_root_dir.glob(r'*/videos/*/*'))
    # video_types = set([x.suffix for x in all_video_paths])  # .mp4, .mov (Apple native), and .3gp (Lenovo native).
    ...
    for video_path in all_video_paths:
        ...
        frame_ids = [idx for idx, x in enumerate(frame_types) if x == 'pict_type=I']
        print(' ')
        break
