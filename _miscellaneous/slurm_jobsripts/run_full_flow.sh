...
#SBATCH --array=1
# --dependency=afterok:23051123

# create the following directory manually
#SBATCH --chdir=/scratch/p288722/runtime_data/scd_videos_first_revision/12_all_frames_bs64
...
#dataset_params="--frame_selection=equally_spaced --frame_type=all --fpv=50 --height=480 --width=800 --all_I_frames_dir=${all_I_frames_dir} --all_frames_dir=${all_frames_dir}"
...
dataset_params="--frame_selection=equally_spaced --frame_type=all --height=480 --width=800 --all_I_frames_dir=${all_I_frames_dir} --all_frames_dir=${all_frames_dir}"
#
