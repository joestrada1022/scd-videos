#!/bin/bash
#SBATCH --job-name=mn-50Iframes-ccrop
#SBATCH --time=6:00:00
#SBATCH --mem=64g
...
#SBATCH --chdir=/scratch/p288722/runtime_data/scd_videos_first_revision/07_ppcce
...
python3 /home/p288722/git_code/scd_videos_first_revision/run_train.py --homo_or_not=None --net_type=mobile --dataset=/data/p288722/datasets/vision/I_frame_splits/bal_50_frames --epochs=20 --lr=0.1 --batch_size=64 --height=480 --width=800 --use_pretrained=1 --gpu_id=0 --const_type=None --model_name=MobileNet_50_I_frames_ccrop_run1 --global_results_dir=/data/p288722/runtime_data/scd_videos_first_revision/08_ppcce_d_0.00001_0.99999/50_frames/mobile_net
python3 /home/p288722/git_code/scd_videos_first_revision/run_evaluate.py --homo_or_not=None --eval_set=val --dataset=/data/p288722/datasets/vision/I_frame_splits/bal_50_frames --batch_size=64 --height=480 --width=800 --gpu_id=0 --suffix=50_frames_val --input_dir=/data/p288722/runtime_data/scd_videos_first_revision/08_ppcce_d_0.00001_0.99999/50_frames/mobile_net/models/MobileNet_50_I_frames_ccrop_run1
python3 /home/p288722/git_code/scd_videos_first_revision/_miscellaneous/plots/validation_plots.py --val_summary=/data/p288722/runtime_data/scd_videos_first_revision/08_ppcce_d_0.00001_0.99999/50_frames/mobile_net/models/MobileNet_50_I_frames_ccrop_run1/predictions_50_frames_val/videos/V_prediction_stats.csv
python3 /home/p288722/git_code/scd_videos_first_revision/run_evaluate.py --homo_or_not=None --eval_set=test --dataset=/data/p288722/datasets/vision/I_frame_splits/bal_50_frames --batch_size=64 --height=480 --width=800 --gpu_id=0 --suffix=50_frames --input_dir=/data/p288722/runtime_data/scd_videos_first_revision/08_ppcce_d_0.00001_0.99999/50_frames_pred/mobile_net/models/MobileNet_50_I_frames_ccrop_run1
