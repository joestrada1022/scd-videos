...
#python3 /home/p288722/git_code/scd_videos_first_revision/dataset/frames/frame_extraction.py --input_dir="/data/p288722/datasets/VISION/dataset" --output_dir="/scratch/p288722/datasets/vision/all_I_frames" --device_id="${SLURM_ARRAY_TASK_ID}"
